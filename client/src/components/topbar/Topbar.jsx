    ...
    <div className="topbarContainer">
      ...
      <div className="topbarCenter">
        <div className="searchbar">
          ...
          {searchuser?searchuser.map(user=>{return <Link to={`/profile/${user._id}`} className="user-search" style={{display:'flex',lineHeight:'50px'}}><Avatar style={{right:'30px'}} src={PF+user.profilePicture}></Avatar><div style={{lineHeight:'50px'}}>{user.username}</div></Link>}):<></>}
          </ul>
